...
const variantStyles = {
  primary:
    'bg-amber-400 font-semibold text-zinc-100 hover:bg-amber-400 active:bg-amber-400 active:text-zinc-100/70 dark:bg-amber-400 dark:hover:bg-amber-400 dark:active:bg-amber-400 dark:active:text-zinc-100/70',
  secondary:
