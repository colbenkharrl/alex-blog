  ...
  return isOpen ? (
    <div className="fixed inset-x-0 bottom-0  z-50" data-testid="SnackBar">
      <div
        ...
        } flex items-center gap-x-6 bg-white bg-opacity-90 px-6 py-2.5 outline outline-2 outline-amber-400 transition-opacity duration-500 ease-out dark:bg-zinc-900 dark:bg-opacity-90 dark:outline-amber-400 sm:px-3.5 sm:before:flex-1 sm:after:flex-1 `}
      >
